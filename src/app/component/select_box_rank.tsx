...
const SelectBoxRankStyle = styled('div')`
    position: relative;
...
const SelectBoxRank = (props : {rankSelect:{key:string, name:string}[], rankSelectIdx:number, setRankSelectIdx:any}) => {
