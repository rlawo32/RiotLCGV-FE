...
const TopIcon = (props : {type:string}) => {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill={customMainColor} width={customWidth} height={customHeight} viewBox="0 0 26 26">
            <path fill={customMainColor} fillRule="evenodd" d="M19 3H3v16l4-4V7h8z" clipRule="evenodd"></path>
            <path fill={customSubColor} fillRule="evenodd" d="M5 21h16V5l-4 4v8H9z" clipRule="evenodd"></path>
