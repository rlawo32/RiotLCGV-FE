...
const RankingView1G3BGold = (props : {data:{
            ...
            <div className="ranking_card">    
                ...
                <Style.RankingBox $ea={props.data.filter((item) => item.rank === 3).length}>
                    {props.data.filter((highRanking) => highRanking.rank === 3).map((item, idx) => {
                        return (
                            <Style.HighRankingCard $rank={3} $image={props.path.lcg_main_image + item.lcg_champion_name +"_0" + props.path.lcg_image_extension} key={"rank3_" + idx}>
                                <div className="card_container">
                                    <div className="card_head">
                                        <div className="card_champion" />
                                        <div className="card_effect" />
...
export default RankingView1G3BGold;