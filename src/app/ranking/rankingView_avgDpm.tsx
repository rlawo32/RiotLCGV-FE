...
const RankingViewAvgDpm = (props : {data:{
                        ...
                        <div key={"lowRank_" + idx}>
                            {
                                idx === 0 ? 
                                        <div className="ranking_item_header">
                                            ...
                                            <div className="item_header item_header_detail">평균 DPM</div>
                                        </div> : <></>
                            }
                            <Style.LowRankingItem $type={""}>
                                ...
                                <div className="item_detail3">DPM {item.avg.toLocaleString()}</div>
...
export default RankingViewAvgDpm;