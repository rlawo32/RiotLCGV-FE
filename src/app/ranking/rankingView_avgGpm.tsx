...
const RankingViewAvgGpm = (props : {data:{
                        ...
                        return (
                            <Style.HighRankingItem $ea={arr.length} $rank={2} $h={duplicationRank(arr.length)} $w={duplicationRank(arr.length)} key={"rank2_" + idx}>
                                ...
                                <Style.RankerContent $ea={arr.length}>
                                    ...
                                    <div className="ranker_title">평균 GPM {item.avg.toLocaleString()}</div>
                                </Style.RankerContent>
                        ...
                        <div key={"lowRank_" + idx}>
                            {
                                idx === 0 ? 
                                        <div className="ranking_item_header">
                                            ...
                                            <div className="item_header item_header_detail">평균 GPM</div>
                                        </div> : <></>
                            }
                            <Style.LowRankingItem $type={""}>
                                ...
                                <div className="item_detail3">GPM {item.avg.toLocaleString()}</div>
...
export default RankingViewAvgGpm;