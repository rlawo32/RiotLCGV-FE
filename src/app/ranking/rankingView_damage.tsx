...
const RankingViewDamage = (props : {data:{
                        ...
                        return (
                            <Style.RankingItem $ea={arr.length} $rank={2} key={"rank2_" + idx}>
                                ...
                                <Style.RankerContent $ea={arr.length}>
                                    ...
                                    <div className="ranker_title">총 {item.lcg_count_damage.toLocaleString()} 피해량</div>
                ...
                {props.data.filter((lowRanking) => lowRanking.rank > 3).map((item, idx) => {
                    return (
                        <div className="ranking_item" key={"lowRank_" + idx}>
                            ...
                            <div className="item_detail">총 {item.lcg_count_damage.toLocaleString()} 피해량</div>
                        </div>
                    )
                })}
            </div>
...
export default RankingViewDamage;