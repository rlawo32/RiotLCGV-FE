...
const RankingViewGold = (props : {data:{
                        ...
                        return (
                            <Style.HighRankingItem $ea={arr.length} $rank={2} key={"rank2_" + idx}>
                                ...
                                <Style.RankerContent $ea={arr.length}>
                                    ...
                                    <div className="ranker_title">총 {item.lcg_count_gold.toLocaleString()} 골드</div>
                                ...
                                idx === 0 || idx === 6 ? 
                                    <>
                                        <div className="ranking_item_header">
                                            ...
                                            <div className="item_header item_header_detail_long">총 골드</div>
                                        </div>
                                        <div className="ranking_item">
                                            ...
                                            <div className="item_detail_long">{item.lcg_count_gold.toLocaleString()} 골드</div>
                                        </div>
                                    </>
                                    :
                                    <div className="ranking_item">
...
export default RankingViewGold;