...
const RankingViewMvp = (props : {data:{
                        ...
                        return (
                            <Style.HighRankingItem $ea={arr.length} $rank={2} $h={duplicationRank(arr.length)} $w={duplicationRank(arr.length)} key={"rank2_" + idx}>
                                ...
                                <Style.RankerContent $ea={arr.length}>
                                    ...
                                    <div className="ranker_title">총 {item.lcg_count_mvp.toLocaleString()}회</div>
                                </Style.RankerContent>
                        ...
                        <div key={"lowRank_" + idx}>
                            {
                                idx === 0 ? 
                                        <div className="ranking_item_header">
                                            ...
                                            <div className="item_header item_header_detail">총 MVP횟수</div>
                                        </div> : <></>
                            }
                            <Style.LowRankingItem $type={""}>
                                ...
                                <div className="item_detail3">{item.lcg_count_mvp.toLocaleString()}회</div>
