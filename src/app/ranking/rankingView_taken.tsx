                                    ...
                                    <div className="ranker_content_sub">
                                        <div className="detail_box">
                                            ...
                                            <div className="box_detail">
                                                {item.lcg_count_taken.toLocaleString()}
                                            </div>
                                        </div>
                                    </div>
                                </Style.RankerContent>
                        ...
                        <div key={"lowRank_" + idx}>
                            {
                                idx === 0 ? 
                                        <div className="ranking_item_header">
                                            ...
                                            <div className="item_header item_header_detail">총 받은피해량</div>
                                        </div> : <></>
                            }
                            <Style.LowRankingItem $type={""}>
                                ...
                                <div className="item_detail3">{item.lcg_count_taken.toLocaleString()}</div>
